...
class HotelCancellationsFlow(FlowSpec):
    ...
    def model_training(self):
        ...
        with mlflow.start_run(run_id=self.mlflow_run_id):
            ...
            dump(self.training_pipeline, "inference_pipeline.joblib")
    ...
    def register_model(self):
        ...
        mlflow.set_tracking_uri(self.tracking_uri)
        with mlflow.start_run(run_id=self.mlflow_run_id):
            mlflow.sklearn.log_model(self.training_pipeline, "hotel-cancellations-model")

            mlflow.register_model(
                "runs:/{}/hotel-cancellations-model".format(self.mlflow_run_id), "hotel-cancellations-model"
            )
